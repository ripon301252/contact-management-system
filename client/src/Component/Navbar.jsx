...
const Navbar = ({ page, setPage }) => {
  ...
  return (
    <div className="sticky top-0 z-50">
      ...
      {/* 🔥 Glow */}
      <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/10 via-blue-500/5 to-purple-500/10 blur-xl"></div>
      ...
      <nav className="relative backdrop-blur-xl bg-white/5 border-b border-white/10 px-4 md:px-10 py-3">
        ...
        <div className="flex justify-between items-center max-w-7xl mx-auto">
          ...
          >
            <LuNotebookTabs className="text-3xl text-cyan-400 group-hover:rotate-6 transition" />
          ...
          <div className="mt-4 md:hidden rounded-xl overflow-hidden">
            ...
            <div className="relative backdrop-blur-xl bg-white/5 border border-white/10 rounded-xl p-4 space-y-3 text-center">
              ...
              <button
                ...
                bg-gradient-to-r from-cyan-500 to-blue-500 mt-2"
              >
                {open ? "Log Out" : "Login"}
